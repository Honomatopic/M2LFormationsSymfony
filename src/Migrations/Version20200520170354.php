 ...
 */
final class Version20200520170354 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        //$this->addSql('ALTER TABLE employe ADD roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', DROP statut, CHANGE motpasse password VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE employe ADD statut TINYINT(1) NOT NULL, DROP roles, CHANGE password motpasse VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE inscrire DROP FOREIGN KEY FK_84CA37A8325980C0');
        $this->addSql('ALTER TABLE inscrire DROP FOREIGN KEY FK_84CA37A89CF0022');
        $this->addSql('DROP INDEX IDX_84CA37A8325980C0 ON inscrire');
        $this->addSql('DROP INDEX IDX_84CA37A89CF0022 ON inscrire');
